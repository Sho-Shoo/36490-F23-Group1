...
class RandomForest(object):
    ...
    def fit(self, start: int, end: int) -> None:
        ...
        # You can also use GridSearchCV to search for hyperparameters if needed.
        # params = {
        #     'n_estimators': [100, 200],
        #     'min_samples_split': [20, 30],
        # }
        # rf_model = GridSearchCV(estimator=rf_model, param_grid=params, cv=3, n_jobs=-1, scoring='accuracy')
