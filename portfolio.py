...
if __name__ == "__main__":
    ...
    rfPath = 'outputs/rf/predictions.pkl'
    rf_long_short, rf_long = calc_portfolio_from_predictions(rfPath)

    with open('outputs/portfolio/long_short_rf.pkl', 'wb') as f:
        pickle.dump(rf_long_short, f)
    with open('outputs/portfolio/long_rf.pkl', 'wb') as f:
        pickle.dump(rf_long, f)
